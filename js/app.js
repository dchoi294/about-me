...
function question_6(){
  ...
  if(countDown === 0){
    alert('You have used all 4 attempts and still got wrong! It was 22.');
    console.log('You have used all 4 attempts and still got wrong! It was 22.');
  }
...
//       console.log(`You got it right! And here are my top 3 favorite food were ${answersFood}`);
//       boolean = true;
//       correctNumb++;
//     }
//   }
...
//   console.log(`Amazing, ${userName}! You got all ${correctNumb} questions about me right! You know about me so well.`);
// } else if(wrongNumb === 7) {
//   alert(`Woah, ${userName}! You got all questions about me wrong, but it is okay, we got plenty of time to know each other!`);
//   console.log(`Woah, ${userName}! You got all questions about me wrong, but it is okay, we got plenty of time to know each other!`);
// } else if(correctNumb <= 6 && noneAnswer === 0){
//   alert(`${userName}, you answered ${correctNumb} questions correct, and ${wrongNumb} wrong.`);
//   console.log(`${userName}, you answered ${correctNumb} questions correct, and ${wrongNumb} wrong.`);
// } else {
...
//   console.log(`${userName}, you answered ${correctNumb} questions correct, ${wrongNumb} wrong, and did not answer correctly ${noneAnswer} questions!`);
// }
